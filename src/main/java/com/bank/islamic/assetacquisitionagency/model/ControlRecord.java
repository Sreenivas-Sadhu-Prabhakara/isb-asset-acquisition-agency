package com.bank.islamic.assetacquisitionagency.model;
...
/**
 * The BIAN control record for this service domain: "Wakala Purchase Mandate Procedure".
 *
 ...
 * to its asset type (Wakala Purchase Mandate). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Wakala Purchase Mandate Procedure";
